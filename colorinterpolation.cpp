...
namespace
{
    ...
    */
                                     ...
                                     const float t)
    {
        ...
        //For the first one e.g.
        //When t = 0, ColorA.r is returned. When t = 1, ColorB.r is returned instead!
    ...
    /*  Interpolates between two colors in CMYK color space.
     ...
     –
     const ...& ColorA
     : color to be interpolated in the respective color model
     –
     const ...& ColorB
     : color to be interpolated in the respective color model
     –
    ...
    */
                                       ...
                                       const float t)
    {
        ...
        InterpolatedColor.k = ColorA.k + (ColorB.k - ColorA.k) * t;
